...
export const en: MessageTree = {
  ...
  streak: {
    ...
    weekdaySat: "S",
    weekdaySun: "S",
    celebrationDay: "Day {day}!",
    celebrationTitle: "Streak extended",
    celebrationBody: "Come back tomorrow to keep it going.",
    celebrationFreezeUsed: "A streak freeze covered a missed day.",
    celebrationNice: "Nice",
  },
  reports: {
