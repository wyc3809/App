...
export const en: MessageTree = {
  ...
  settings: {
    ...
    reportsDesc: "Spotify-style summaries for ledger and net worth — auto-show each week and month.",
    viewWeekly: "View weekly ledger recap",
    viewMonthly: "View monthly net worth recap",
