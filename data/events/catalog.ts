    ...
    choices: [
      {
        id: 'cry',
        text: '哭聲洪亮',
        outcomes: [{ effects: [{ type: 'attr', delta: { genGu: 2 } }, { type: 'narrate', text: '穩婆說你根骨不俗。' }] }],
      },
      {
        id: 'quiet',
        text: '安靜凝視',
        outcomes: [{ effects: [{ type: 'attr', delta: { wuXing: 2 } }, { type: 'narrate', text: '目光清明，似能辨善惡。' }] }],
      },
    ],
  },
  {
    ...
    choices: [
      {
        id: 'stick',
        text: '木劍為伴',
        outcomes: [{ effects: [{ type: 'martial', amount: 2 }, { type: 'attr', delta: { danShi: 1 } }] }],
      },
      {
        id: 'book',
        text: '偷聽說書',
        outcomes: [{ effects: [{ type: 'attr', delta: { wuXing: 2, meiLi: 1 } }] }],
      },
    ],
  },
  {
    ...
    choices: [
      {
        id: 'help',
        text: '幫父母分憂',
        outcomes: [{ effects: [{ type: 'money', amount: 5 }, { type: 'attr', delta: { meiLi: 1 } }] }],
      },
      {
        id: 'complain',
        text: '怨天尤人',
        outcomes: [{ effects: [{ type: 'attr', delta: { fuYuan: -2 } }, { type: 'reputation', amount: -3 }] }],
      },
    ],
  },
  {
    ...
    choices: [
      {
        id: 'keep',
        text: '收進懷裡',
        outcomes: [{ effects: [{ type: 'money', amount: 15 }, { type: 'attr', delta: { fuYuan: 1 } }] }],
      },
      {
        id: 'return',
        text: '交還失主',
        outcomes: [{ effects: [{ type: 'reputation', amount: 8 }, { type: 'attr', delta: { meiLi: 2 } }] }],
      },
    ],
  },
  {
    ...
    choices: [
      ...
      },
      {
        id: 'ignore',
        text: '匆匆離去',
        outcomes: [{ effects: [{ type: 'narrate', text: '道人歎息，轉身沒入人海。' }] }],
      },
    ],
  },
  {
    ...
    choices: [
      {
        id: 'join',
        text: '拜入山門',
        outcomes: [{ effects: [{ type: 'joinSect' }, { type: 'martial', amount: 5 }] }],
      },
      {
        id: 'decline',
        text: '婉言謝絕',
        outcomes: [{ effects: [{ type: 'attr', delta: { danShi: 1 } }, { type: 'narrate', text: '你選擇闖蕩江湖，不入門牆。' }] }],
      },
    ],
  },
  {
    ...
    choices: [
      {
        id: 'hard',
        text: '苦練不止',
        outcomes: [{ effects: [{ type: 'martial', amount: 6 }, { type: 'health', amount: -5 }] }],
      },
      {
        id: 'rest',
        text: '適度調息',
        outcomes: [{ effects: [{ type: 'martial', amount: 3 }, { type: 'health', amount: 5 }] }],
      },
    ],
  },
  {
        ...
        outcomes: [
          {
            effects: [
              ...
              { type: 'narrate', text: '你與一位青衣少俠（俠女）相談甚歡。' },
            ],
          },
        ],
      },
    ...
    choices: [
      {
        ...
        outcomes: [
          ...
          {
            chance: 0.35,
            effects: [{ type: 'narrate', text: '對方婉拒，你黯然離去。' }, { type: 'health', amount: -10 }],
          },
        ],
      },
      {
        ...
        outcomes: [
          {
            ...
            effects: [
              ...
              { type: 'narrate', text: '你僅勝半招，對手抱拳而退。' },
            ],
          },
          {
            chance: 0.45,
            effects: [{ type: 'health', amount: -25 }, { type: 'narrate', text: '你敗北受傷。' }],
          },
        ],
      },
      {
    ...
    choices: [
      {
        id: 'invest',
        text: '投資貨棧',
        outcomes: [{ effects: [{ type: 'money', amount: 60 }, { type: 'attr', delta: { fuYuan: 1 } }] }],
      },
      {
        id: 'pass',
        text: '穩妥為上',
        outcomes: [{ effects: [{ type: 'money', amount: 10 }] }],
      },
    ],
  },
  {
    ...
    choices: [
      {
        id: 'aid',
        text: '施粥救患',
        outcomes: [{ effects: [{ type: 'health', amount: -15 }, { type: 'reputation', amount: 15 }] }],
      },
      {
        id: 'flee_city',
        text: '離城避禍',
        outcomes: [{ effects: [{ type: 'money', amount: -20 }, { type: 'health', amount: 5 }] }],
      },
    ],
  },
  {
    ...
    choices: [
      ...
      },
      {
        id: 'watch',
        text: '旁觀學藝',
        outcomes: [{ effects: [{ type: 'martial', amount: 5 }, { type: 'attr', delta: { wuXing: 2 } }] }],
      },
    ],
  },
  {
    ...
    choices: [
      {
        id: 'explain',
        text: '稟明掌門',
        outcomes: [{ effects: [{ type: 'reputation', amount: 5 }] }],
      },
      {
        id: 'leave',
        text: '憤而離山',
        outcomes: [{ effects: [{ type: 'leaveSect' }, { type: 'martial', amount: 2 }] }],
      },
    ],
  },
  {
    ...
    choices: [
      {
        id: 'accept',
        text: '奉命行事',
        outcomes: [{ effects: [{ type: 'money', amount: 35 }, { type: 'martial', amount: 5 }, { type: 'reputation', amount: 8 }] }],
      },
      {
        id: 'refuse',
        text: '稱病推辭',
        outcomes: [{ effects: [{ type: 'reputation', amount: -8 }] }],
      },
    ],
  },
  {
    ...
    choices: [
      {
        id: 'recite',
        text: '即興吟詩',
        outcomes: [{ effects: [{ type: 'reputation', amount: 12 }, { type: 'attr', delta: { meiLi: 2 } }] }],
      },
      {
        id: 'drink',
        text: '只顧暢飲',
        outcomes: [{ effects: [{ type: 'health', amount: -5 }, { type: 'money', amount: -8 }] }],
      },
    ],
  },
  {
    ...
    choices: [
      ...
      },
      {
        id: 'escape',
        text: '翻窗逃走',
        outcomes: [{ effects: [{ type: 'health', amount: -10 }, { type: 'reputation', amount: -10 }] }],
      },
    ],
  },
  {
    ...
    choices: [
      {
        id: 'care',
        text: '床前盡孝',
        outcomes: [{ effects: [{ type: 'money', amount: -25 }, { type: 'attr', delta: { meiLi: 3, fuYuan: 2 } }] }],
      },
      {
        id: 'doctor',
        text: '請名醫診治',
        outcomes: [{ effects: [{ type: 'money', amount: -50 }, { type: 'reputation', amount: 5 }] }],
      },
    ],
  },
  {
    ...
    choices: [
      {
        id: 'serve',
        text: '從軍出征',
        outcomes: [{ effects: [{ type: 'martial', amount: 10 }, { type: 'health', amount: -25 }, { type: 'reputation', amount: 10 }] }],
      },
      {
        id: 'bribe',
        text: '設法逃避',
        outcomes: [{ effects: [{ type: 'money', amount: -40 }, { type: 'reputation', amount: -15 }] }],
      },
    ],
  },
  {
    ...
    choices: [
      {
        id: 'join',
        text: '捲入其中',
        outcomes: [{ effects: [{ type: 'health', amount: -12 }, { type: 'martial', amount: 2 }] }],
      },
      {
        id: 'mediate',
        text: '居中調停',
        outcomes: [{ effects: [{ type: 'reputation', amount: 6 }, { type: 'attr', delta: { meiLi: 1 } }] }],
      },
    ],
  },
  {
    ...
    choices: [
      {
        id: 'save',
        text: '跳水救人',
        outcomes: [{ effects: [{ type: 'reputation', amount: 10 }, { type: 'health', amount: -8 }, { type: 'attr', delta: { danShi: 2 } }] }],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    choices: [
      ...
      },
      {
        id: 'trust',
        text: '選擇信任',
        outcomes: [{ effects: [{ type: 'attr', delta: { meiLi: 2 } }] }],
      },
    ],
  },
  {
    ...
    choices: [
      {
        id: 'give',
        text: '布施銀錢',
        outcomes: [{ effects: [{ type: 'money', amount: -5 }, { type: 'attr', delta: { fuYuan: 3 } }] }],
      },
      {
        id: 'listen',
        text: '聽經半日',
        outcomes: [{ effects: [{ type: 'attr', delta: { wuXing: 2 } }] }],
      },
    ],
  },
  {
    ...
    choices: [
      {
        id: 'buy',
        text: '重金求劍',
        outcomes: [{ effects: [{ type: 'money', amount: -50 }, { type: 'martial', amount: 5 }] }],
      },
      {
        id: 'apprentice',
        text: '學徒打雜',
        outcomes: [{ effects: [{ type: 'martial', amount: 3 }, { type: 'money', amount: -10 }] }],
      },
    ],
  },
  {
    ...
    choices: [
      {
        id: 'serve_court',
        text: '入朝為官',
        outcomes: [{ effects: [{ type: 'money', amount: 80 }, { type: 'reputation', amount: 20 }, { type: 'flag', key: 'court_official', value: true }] }],
      },
      {
        id: 'decline_court',
        text: '辭不就徵',
  ...
  },
  {
    ...
    choices: [
      ...
      },
      {
        id: 'ignore_rumor',
        text: '一笑置之',
        outcomes: [{ effects: [{ type: 'attr', delta: { wuXing: 1 } }] }],
      },
    ],
  },
  {
    ...
    choices: [
      ...
      },
      {
        id: 'send',
        text: '讓弟子試',
        outcomes: [{ effects: [{ type: 'reputation', amount: -12 }] }],
      },
    ],
  },
  {
    ...
    choices: [
      {
        id: 'gift',
        text: '厚禮出席',
        outcomes: [{ effects: [{ type: 'money', amount: -15 }, { type: 'reputation', amount: 6 }] }],
      },
      {
        id: 'perform',
        text: '獻藝助興',
        outcomes: [{ effects: [{ type: 'reputation', amount: 10 }, { type: 'martial', amount: 1 }] }],
      },
    ],
  },
  {
    ...
    choices: [
      {
        id: 'practice',
        text: '月下苦練',
        outcomes: [{ effects: [{ type: 'martial', amount: 4 }, { type: 'health', amount: -3 }] }],
      },
    ],
  },
  {
    ...
    choices: [
      {
        id: 'calm',
        text: '靜心辨位',
        outcomes: [{ effects: [{ type: 'attr', delta: { wuXing: 2, danShi: 1 } }] }],
      },
      {
        id: 'panic',
        text: '慌亂奔逃',
        outcomes: [{ effects: [{ type: 'health', amount: -12 }] }],
      },
    ],
  },
  {
    ...
    choices: [
      ...
      },
      {
        id: 'proper',
        text: '正規借閱',
        outcomes: [{ effects: [{ type: 'martial', amount: 4 }] }],
      },
    ],
  },
  {
    ...
    choices: [
      {
        id: 'write',
        text: '撰寫遊記',
        outcomes: [{ effects: [{ type: 'reputation', amount: 15 }, { type: 'narrate', text: '後人讀你的筆記，如見江湖。' }] }],
      },
      {
        id: 'teach',
        text: '傳功後輩',
        outcomes: [{ effects: [{ type: 'reputation', amount: 20 }, { type: 'flag', key: 'legacy_teacher', value: true }] }],
      },
    ],
  },
  {
    ...
    choices: [
      ...
      },
      {
        id: 'accept',
        text: '安然面對',
        outcomes: [{ effects: [{ type: 'attr', delta: { danShi: 3 } }] }],
      },
    ],
  },
  {
    ...
    choices: [
      ...
      },
      {
        id: 'retire',
        text: '金盆洗手',
        outcomes: [{ effects: [{ type: 'flag', key: 'retired', value: true }, { type: 'martial', amount: -5 }] }],
      },
    ],
  },
  {
    ...
    choices: [
      {
        id: 'pass',
        text: '立族規傳後人',
        outcomes: [{ effects: [{ type: 'flag', key: 'family_legacy', value: true }, { type: 'reputation', amount: 10 }] }],
      },
    ],
  },
  {
    ...
    choices: [
      {
        id: 'pay',
        text: '花錢算命',
        outcomes: [{ effects: [{ type: 'money', amount: -8 }, { type: 'attr', delta: { fuYuan: 2 } }] }],
      },
    ],
  },
  {
    ...
    choices: [
      {
        id: 'rest',
        text: '平淡度日',
        outcomes: [{ effects: [{ type: 'health', amount: 5 }, { type: 'attr', delta: { fuYuan: 1 } }] }],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    choices: [
      ...
      },
      {
        id: 'miss',
        text: '錯過機緣',
        outcomes: [{ effects: [{ type: 'narrate', text: '回頭已不見人影。' }] }],
      },
    ],
  },
];
